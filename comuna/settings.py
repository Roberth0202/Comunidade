...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.context_processors.follow_counts',
            ],
        },
    },
]

WSGI_APPLICATION = 'comuna.wsgi.application'
...
AUTH_PASSWORD_VALIDATORS = [
    {
        ...
        # verifica se o usuario e o email são iguais
    },
    {
...
# para enviar email pro email oficial
